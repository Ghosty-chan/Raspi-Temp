...
<div id="container">
	<div id="checkfields">
	<form action="php/long_data.php" method="post" target="longdata_frame">
		<?php
	...
	<br>
	<input type="submit" value="Neuladen" style='height:25px;width:100px;border-radius:25px;'>
	...
	<hr>	
		<iframe name='longdata_frame' src='php/test.html' style='display:block;margin:0;padding:0;overflow:hidden;width:100%;background-color:#fff;' hspace='0' marginheight='0' frameBorder='0' height='800px'></iframe>
